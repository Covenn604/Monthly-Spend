...
**Version 0.1.0 — initial functional prototype.** Desktop and mobile web interface; manual transactions and CSV import; one shared household password and one currency (CAD by default). Data lives in SQLite on your Docker host, not in GitHub or browser storage. No bank connections, external analytics, or runtime CDNs.
